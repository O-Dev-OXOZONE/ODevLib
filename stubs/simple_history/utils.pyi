...
def bulk_update_with_history(objs, model, fields, batch_size: Incomplete | None = ..., default_user: Incomplete | None = ..., default_change_reason: Incomplete | None = ..., default_date: Incomplete | None = ..., manager: Incomplete | None = ...) -> None: ...
